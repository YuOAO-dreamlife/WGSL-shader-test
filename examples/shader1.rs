...
fn main() {
    ...
    // 設置 `Shader1Material`
    app.add_plugin(MaterialPlugin::<Shader1Material>::default());
...
fn setup(
    ...
    mut materials: ResMut<Assets<Shader1Material>>,
) {
    // 視角相機
    ...
    commands.spawn(MaterialMeshBundle {
        ...
        material: materials.add(Shader1Material {}),
        ..default()
    });
...
struct Shader1Material {}

impl Material for Shader1Material {
    fn fragment_shader() -> ShaderRef {
        "shaders\\shader1.wgsl".into()
    }
}
